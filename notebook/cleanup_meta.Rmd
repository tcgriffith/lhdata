...
```{r testgettag, eval=FALSE}
geinin_map =
  data.table::fread(fill =TRUE, sep2=" ",here::here("/data/geinin_list.txt"), header =FALSE)
...
get_tags(testtext, known_keys= geinin_map.s$V1)
...
```{r}
dummy = pbapply::pbsapply(f, update_tags, new_tags)
