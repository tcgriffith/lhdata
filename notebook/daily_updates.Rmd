...
# writeLines(jsonlite::prettify(jsonlite::toJSON(mid.df)), con = here::here("data/mid.df.json"))
...
write.csv2(mid.df, paste0(pkg_path,"/data/author_list.csv"))
...
vlist.new.anno <-annotate_vlist(vlist.new, imgur = FALSE)
