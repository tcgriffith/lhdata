...
source(paste0(pkg_path,"/R/api_getuploads.R"))
source(paste0(pkg_path,"/R/getbangumi.R"))
source(paste0(pkg_path,"/R/getyearsdf.R"))
source(paste0(pkg_path,"/R/api_aid2cid.R"))
source(paste0(pkg_path,"/R/api_getbilitags.R"))
source(paste0(pkg_path,"/R/api_upload_imgur.R"))
source(paste0(pkg_path,"/R/generate_posts2.R"))
